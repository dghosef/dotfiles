  ...
  xsession.windowManager.i3 = {
    ...
    config = {
	  ...
	  position = "top";
          ...
          statusCommand = "i3status-rs ${./i3status}";
	  colors.background = status_bg;
	  colors.separator = "#44475A";
	  colors.focusedWorkspace = {border = fg; background = status_bg; text = fg;};
	  colors.inactiveWorkspace = {border = status_bg; background = status_bg; text = fg;};
        }
      ];
